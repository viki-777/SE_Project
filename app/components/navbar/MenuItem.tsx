  ...
  return (
    ...
    >
      ...
      {items.submenu ? (
        <>
          ...
          >
            {window.innerWidth < 960 && depthLevel === 0 ? (
              ...
              <div className="border rounded-full bg-emerald-600 py-2 px-5 flex  text-slate-200  items-center gap-2 ">
        ...
        <div
          className="hover:bg-emerald-200 py-2   w-full cursor-pointer px-2"
          onClick={handleClick}
        >
          {items.title}
        </div>
