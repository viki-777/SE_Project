  ...
  return (
    <div className="relative">
      <div className="flex flex-row items-center gap-3">
        <div
          onClick={() => router.push('/')}
          className="sm:hidden cursor-pointer text-sm font-semibold hover:scale-105" // Add hover effect
        >
          Home
        </div>
        <div
          onClick={() => router.push('/about')}
          className="cursor-pointer text-sm font-semibold hover:scale-105"
        >
          About
        </div>
        <div
