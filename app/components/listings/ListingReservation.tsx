...
const ListingReservation: React.FC<ListingReservationProps> = ({
  ...
  const total = (price + taxPrice - discount).toFixed(2);

  return (
    <div className="bg-white rounded-xl border-[1px] border-neutral-200 overflow-hidden">
      <div className="flex flex-row items-center gap-1 p-4">
        <div className="text-2xl font-semibold text-emerald-600 ">Price - ₹{price}</div>
      </div>
      <hr />
      <Calendar
        color="#059669"
  ...
  <div className="flex items-center space-x-2">
    ...
    <span>Unavailable</span>
      ...
      <div className="flex flex-col p-2">
        ...
        <Button label="Book" disabled={disabled} onClick={onSubmit} />
      </div>
    </div>
  );
};
...
//     // Save the necessary reservation details in session storage, state, or URL parameters
